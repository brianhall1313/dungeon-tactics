...
func load_default_data():
	...
	"party":[
		...
		{"abilities":[],"character_name":"Darrell","equipment":["light_armor","bow","sword"],"experience":0,"inventory":[],"job":"ranger","level":0,"spells":[],"stats":{"armor":11,"combat":2,"health":12,"move":7,"ranged_combat":2,"will":2},"tags":["humanoid"]},
		{"job":"templar","tags":["humanoid"],"stats":{"move":6,"combat":4,"ranged_combat":0,"armor":10,"will":1,"health":12},"equipment":["great_weapon","heavy_armor"],"spells":[],"abilities":[]},
		...
		{"job":"thug","tags":["humanoid"],"stats":{"move":6,"combat":2,"ranged_combat":0,"armor":10,"will":-1,"health":10},"equipment":["hand_weapon"],"spells":[],"abilities":[]},
		{"job":"archer","tags":["humanoid"],"stats":{"move":6,"combat":1,"ranged_combat":2,"armor":10,"will":0,"health":10},"equipment":["bow","dagger","light_armor"],"spells":[],"abilities":[],},
		{"abilities":[],"job":"treasure_hunter","tags":["humanoid"],"stats":{"move":7,"combat":3,"ranged_combat":0,"armor":10,"will":2,"health":12},"equipment":["hand_weapon","light_armor"]},
